...
class UiTF extends React.Component {
  ...
  onChangeSliderTF() {
    ...
    const store = this.props;
    store.dispatch({
      type: StoreActionType.SET_SLIDER_3DR,
      slider3d_r: Number.parseFloat(aval[0]),
    });
    store.dispatch({
      type: StoreActionType.SET_SLIDER_3DG,
      slider3d_g: Number.parseFloat(aval[1]),
    });
    store.dispatch({
      type: StoreActionType.SET_SLIDER_3DB,
      slider3d_b: Number.parseFloat(aval[2]),
    });
  }
  ...
  onChangeSliderOpacity() {
    ...
    const store = this.props;
    store.dispatch({
      type: StoreActionType.SET_SLIDER_Opacity,
      sliderOpacity: Number.parseFloat(aval),
    });
  }
  ...
  onChangeSliderIsosurface() {
    ...
    const store = this.props;
    store.dispatch({
      type: StoreActionType.SET_SLIDER_Isosurface,
      sliderIsosurface: Number.parseFloat(aval),
    });
  }
  ...
  onChangeSliderErRadius() {
    ...
    const store = this.props;
    store.dispatch({
      type: StoreActionType.SET_SLIDER_ErRadius,
      sliderErRadius: Number.parseFloat(aval),
    });
  }
  ...
  onChangeSliderErDepth() {
    ...
    const store = this.props;
    store.dispatch({
      type: StoreActionType.SET_SLIDER_ErDepth,
      sliderErDepth: Number.parseFloat(aval),
    });
  }
  ...
  render() {
    ...
    */
    ...
    const jsxArray = [jsxIsoTF, jsxRayfastTF];
